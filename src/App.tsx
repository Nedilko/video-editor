...
function App() {
  ...
  return <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
    <Layout>
      ...
      >
        <ResizablePanel id="editor" defaultSize={80} className="border rounded-md">
          <Editor isSidebarOpened={isSidebarOpened} onOpenSidebar={openSidebar}/>
        </ResizablePanel>
        {isSidebarOpened && (
          <>
            <ResizableHandle withHandle/>
            <ResizablePanel id="sidebar" defaultSize={20} className="border rounded-md" minSize={20} maxSize={40}>
